...
As $|b-a|\rightarrow 0$ the error decay at $|b-a|^{2n+3}$, which is better than the $|b-a|^{n+2}$ or $|b-a|^{n+3}$ in Newton-Cotes.
    ...
    Firstly find the quadrature points. The first method is by using the formula of Lagrange polynomials in HW4 problem 4, which is $(1-x^2)''=12x^2-4$, so roots are $\pm{1\over\sqrt{3}}$, so $x_0={\pi/2}(1-1/\sqrt{3})=0.6639$, $x_1={\pi/2}(1+1/\sqrt{3})=2.4777$.
...
\[\int_0^\pi (x^2+ax+b)dx={\pi^2\over 3}+{a\pi\over 2}+b\pi=0\]
