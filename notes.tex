...
\[=\left(\begin{array}{c}0.0.368540984834\\ 1.32870768929\times 10^{16} \end{array}\right)\]
...
\item Euler's method
\item \begin{enumerate}
   \item One step: truncated error, consistency, order of accuracy
   \item Globally: global error, convergence, zero-stability
   \end{enumerate}
