...
4. \begin{itemize}
\item Suppose $f$ is continuous on $[0, 1]$. Let $I_n$ be the estimate of $\int_0^1fdx$ using composite trapezium rule. Show that there is some $C$ independent from $n$, such that
  \[|\int_0^1fdx-I_n|\leq {C\over n}\]
 Hint: use the definition of absolute continuity.
