...
%Sorry there is a mistake in the statement of the problem, $p_{n-1}$ need to be of weight $1-x^2$. This problem is cancelled.\\

%\begin{itemize}
%\item $I_n$ has $n+1$ quadrature points hence gives accurate answer to any polynomial of degree up to $n$. If $q$ is of degree no more than $2n-1$, by long division of polynomials we have $q=(x^2-1)p_{n-1}q_1+r$, where $r$ is of degree at most $n$, and $q_1$ is a polynomial of degree no more than $n-2$.  
%\
